...
struct CardPopUp_Previews: PreviewProvider {
    static var previews: some View {
        CardPopUp(selectedAthlete: Athlete(title: "Serena Williams", image: Image("Williams"), bday: "September 26, 1981", sport: "Tennis",
